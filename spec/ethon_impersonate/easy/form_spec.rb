...
describe EthonImpersonate::Easy::Form do
  ...
  let(:form) { EthonImpersonate::Easy::Form.new(easy, hash) }
  ...
  describe "#materialize" do
    ...
    context "when query_pairs contains string values" do
      ...
      it "adds params to form" do
        expect(EthonImpersonate::Curl).to receive(:formadd)
        form.materialize
      end
    end
    ...
    context "when query_pairs contains file and string values" do
      ...
      it "adds file to form" do
        expect(EthonImpersonate::Curl).to receive(:formadd).twice
        form.materialize
      end
    end
    ...
    context "when query_pairs contains file, string and int values" do
      ...
      it "adds file to form" do
        expect(EthonImpersonate::Curl).to receive(:formadd).exactly(3).times
        form.materialize
      end
    end
  end
