...
describe EthonImpersonate::Easy::Operations do
  ...
  describe "#perform" do
    ...
    it "calls Curl.easy_perform" do
      expect(EthonImpersonate::Curl).to receive(:easy_perform)
      easy.perform
    end
    ...
    it "doesn't log after completing because completing could reset" do
      easy.on_complete{ expect(EthonImpersonate.logger).to receive(:debug).never }
      easy.perform
    end
