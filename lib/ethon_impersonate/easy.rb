...
require 'ethon_impersonate/easy/informations'
require 'ethon_impersonate/easy/features'
require 'ethon_impersonate/easy/callbacks'
require 'ethon_impersonate/easy/options'
require 'ethon_impersonate/easy/header'
require 'ethon_impersonate/easy/util'
require 'ethon_impersonate/easy/params'
require 'ethon_impersonate/easy/form'
require 'ethon_impersonate/easy/http'
require 'ethon_impersonate/easy/operations'
require 'ethon_impersonate/easy/response_callbacks'
require 'ethon_impersonate/easy/debug_info'
require 'ethon_impersonate/easy/mirror'
...
module EthonImpersonate
  ...
  #
  #   e = EthonImpersonate::Easy.new(url: "www.example.com")
  #   e.perform
  #   #=> :ok
  #
  ...
  # @see initialize
  class Easy
    include EthonImpersonate::Easy::Informations
    include EthonImpersonate::Easy::Callbacks
    include EthonImpersonate::Easy::Options
    include EthonImpersonate::Easy::Header
    include EthonImpersonate::Easy::Http
    include EthonImpersonate::Easy::Operations
    include EthonImpersonate::Easy::ResponseCallbacks
    extend EthonImpersonate::Easy::Features
    ...
    # Look into {EthonImpersonate::Easy::Options Options} to see what you can provide in the
    # options hash.
    #
    ...
    def to_hash
      Kernel.warn("EthonImpersonate: Easy#to_hash is deprecated and will be removed, please use #mirror.")
      mirror.to_hash
    end
